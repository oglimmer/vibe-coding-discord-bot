...
class DemoDataCreator:
    ...
    def create_factcheck_data(self):
        ...
        claims_and_responses = [
            ...
            (
                ...
                "Das ist völlig falsch! Giraffen haben sehr wohl eine Zunge - sogar eine besonders lange (bis 50cm) und dunkle Zunge, die ihnen hilft, Blätter zu greifen.",
                5,
            ),
            (
                "Die Erde ist flach und NASA gibt es gar nicht, das sind alles Schauspieler!",
                "Definitiv falsch! Die Erde ist nachweislich rund, NASA existiert seit 1958 und Tausende von Wissenschaftlern arbeiten dort.",
                2,
            ),
            (
                "Chemtrails sind Regierungsverschwörung um uns zu kontrollieren!",
                "Das ist eine Verschwörungstheorie ohne wissenschaftliche Basis. Kondensstreifen entstehen durch Wasserdampf in der Atmosphäre.",
                15,
            ),
            (
                "Impfungen enthalten 5G-Chips zur Gedankenkontrolle!",
                "Völlig haltlos! Impfstoffe enthalten keine Mikrochips. Das ist eine weit verbreitete Falschinformation.",
                8,
            ),
            (
                "Katzen können durch Wände gehen, das verschweigen Wissenschaftler!",
                "Quatsch! Katzen sind normale Säugetiere ohne übernatürliche Fähigkeiten wie Phasenverschiebung.",
                3,
            ),
            # Medium Accuracy (21-60%) - Teilweise falsch oder übertrieben
            (
                "Einstein hat die Relativitätstheorie von seiner Frau geklaut!",
                "Das ist übertrieben. Mileva Marić hat Einstein bei seinen Arbeiten unterstützt, aber die Relativitätstheorie stammt von Einstein.",
                35,
            ),
            (
                "Bananen sind radioaktiv und deshalb gefährlich!",
                "Bananen enthalten minimal Kalium-40, aber die Strahlung ist völlig ungefährlich. Man müsste Millionen essen für Schäden.",
                45,
            ),
            (
                "Wir nutzen nur 10% unseres Gehirns!",
                "Das ist ein Mythos! Moderne Hirnscans zeigen, dass wir praktisch alle Bereiche des Gehirns nutzen, nur nicht gleichzeitig.",
                25,
            ),
            (
                "Haie bekommen nie Krebs!",
                "Das stimmt nicht. Haie können durchaus Krebs bekommen, auch wenn es seltener vorkommt als bei anderen Tieren.",
                40,
            ),
            # Higher Accuracy (61-80%) - Größtenteils korrekt oder nur kleinere Fehler
            (
                "Die Chinesische Mauer sieht man vom Weltraum aus!",
                "Das ist ein weit verbreiteter Irrtum. Man kann die Mauer nicht mit bloßem Auge aus dem Weltraum sehen.",
                65,
            ),
            (
                "Menschen haben nur 5 Sinne!",
                "Nicht ganz richtig. Menschen haben mehr als 5 Sinne, z.B. Gleichgewichtssinn, Temperatursinn, Schmerzempfindung.",
                70,
            ),
            (
                "Gold ist das schwerste Element!",
                "Falsch. Gold ist schwer, aber nicht das schwerste Element. Osmium und andere sind dichter.",
                62,
            ),
            (
                "Kamele speichern Wasser in ihren Höckern!",
                "Nicht korrekt. Kamele speichern Fett in den Höckern, nicht Wasser. Das Fett kann aber zu Wasser umgewandelt werden.",
                55,
            ),
            # High Accuracy (81-100%) - Mostly correct with minor issues
            (
                "Diamanten sind die härtesten natürlichen Materialien!",
                "Das stimmt! Diamanten haben eine Härte von 10 auf der Mohs-Skala und sind tatsächlich das härteste natürliche Material.",
                95,
            ),
            (
                "Der menschliche Körper besteht zu etwa 60% aus Wasser!",
                "Das ist im Wesentlichen korrekt! Bei Erwachsenen liegt der Wasseranteil zwischen 50-70%, je nach Alter und Geschlecht.",
                88,
            ),
        ]
        ...
        for i, (claim, response, bs_score) in enumerate(claims_and_responses):
            ...
            """,
                (
                    ...
                    True,
                    987654321098765432,
                    123456789012345678,  # Demo server and channel IDs
                ),
            )
    ...
    def create_ai_cache_data(self):
        ...
        sample_caches = [
            (
                "Ist die Erde flach?",
                "factcheck",
                "Nein, die Erde ist nicht flach. Sie ist ein Geoid...",
                15,
            ),
            (
                "Chemtrails existieren",
                "klugscheiss",
                "Kondensstreifen sind normale Wetterphänomene...",
                20,
            ),
            (
                "5G verursacht Corona",
                "factcheck",
                "Es gibt keinen wissenschaftlichen Zusammenhang...",
                5,
            ),
            (
                "Impfungen sind gefährlich",
                "klugscheiss",
                "Impfungen sind sicher und schützen vor Krankheiten...",
                85,
            ),
        ]
    ...
    def create_greeting_data(self):
        ...
        for days_ago in range(14):
            ...
            greeting_time = time(
                hour=random.randint(6, 10), minute=random.randint(0, 59)
            )
